...
//var attribution = L.control.attribution( position: 'topright'
//attribution.setPrefix(''),
//attribution.addAttribution('<a href="https://twitter.com/laurenancona">© 2015 Lauren Ancona</a> | <a href="http://phila.gov">City of Philadelphia</a> | <a href="http://openstreetmap.org/copyright">Map data: © OpenStreetMap</a> | <a href="http://mapbox.com/map-feedback/" class="mapbox-improve-map">Improve this map</a>'});
...
//cartodb.createLayer(map,'https://lancona.cartodb.com/api/v2/viz/e0be42f8-5d45-11e5-ae28-0e0c41326911/viz.json').addTo(map);


// Gather all our transit layers
//
//var stations = L.mapbox.featureLayer();
//stations.loadURL('data/stations.geojson');
//
//var lines = L.mapbox.featureLayer();
//lines.loadURL('data/lines.geojson');
//
//var stationinfo = L.mapbox.featureLayer();
//stationinfo.loadURL('data/stationinfo.geojson');
//
//var transitLayers = L.layerGroup([stations, lines, stationinfo]);
...
//cartoLayer = "https://lancona.cartodb.com/api/v2/viz/e0be42f8-5d45-11e5-ae28-0e0c41326911/viz.json"
...
hospitals.on('click', function (e) {
  e.layer.closePopup();
  var feature = e.layer.feature;
  var content = '<div class="titleCase"><strong>' + feature.properties.name + '</strong>' +
